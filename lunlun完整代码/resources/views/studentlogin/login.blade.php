...
<link href="{{asset('static/bootstrap/css/reset.css')}}">
<link href="{{asset('static/bootstrap/css/style1.css')}}">
<link href="{{asset('static/bootstrap/css/supersized.css')}}">
<BODY>
...
<DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
    ...
    <form action="" method="post">
        ...
        <P style="padding: 30px 0px 10px; position: relative;"><SPAN
                    class="u_logo"></SPAN>         <INPUT class="ipt" type="text" name="student_name" placeholder="请输入用户名或邮箱" value="">
        </P>
        <P style="position: relative;"><SPAN class="p_logo"></SPAN>
            <INPUT class="ipt" id="password" type="password" name="student_pwd" placeholder="请输入密码" value="">
        </P>
        <p>
            <label><input name="role" type="radio" value="学生"/>学生</label>
            <label><input name="role" type="radio" value="教师"/>教师</label>
        </p>
        @if(session('msg'))
            <p style=" ">{{ session('msg')}}</p>
        @endif
...
<!-- Javascript -->
<script src="{{asset('static/bootstrap/js/juqery-1.8.2.min.js')}}"></script>
<script src="{{asset('static/bootstrap/js/scripts.js')}}"></script>
<script src="{{asset('static/bootstrap/js/supersized.3.2.7.min.js')}}"></script>
<script src="{{asset('static/bootstrap/js/supersized-init.js')}}"></script>
</BODY>
</HTML>
