...
<DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
    ...
    <form action="" method="post">
        ...
        <P style="position: relative;padding-bottom: 10px;font-size: 20px;">
            选择学院：
            <select  id="college" name="select" style="font-size: 20px;">
                <option style="width:200px" value="软件">软件</option>
                <option style="width:200px"value="音乐">音乐</option>
                <option style="width:200px"value="体育">体育</option>
                <option style="width:200px"value="物理">物理</option>
                <option style="width:200px"value="文学院">文学院</option>
            </select>
        </P>
        <a href="login"> <input type="submit" name="Submit" value="" >返回</a>
