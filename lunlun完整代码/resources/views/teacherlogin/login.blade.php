    ...
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                ...
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                   ...
                   <!--  <div class="form-group">
                        <div class="field">
                           ...
                           <img src="{{asset('static/bootstrap/images/passcode.jpg')}}" alt="" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;" onclick="this.src=this.src+'?'">  
                ...
                <?php echo csrf_field(); ?>
                <div style="padding:30px;"><input type="submit" class="button button-block bg-main text-big input-big" value="登录" name="submit"></div>
            </div>
            </form>          
        </div>
    </div>
